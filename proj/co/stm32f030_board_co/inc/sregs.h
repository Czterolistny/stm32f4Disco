...
#define SREGS_ESP_DTR_RTS_EN_DEFAULT_STATE  ((bool) 1u)
...
#define SREGS_SD_CS_DEFAULT_STATE           ((bool) 1u)
#define SREGS_SREG1_OUT_DEFAULT_STATE       ((bool) 0u)
#define SREGS_ESP_EN_DEFAULT_STATE          ((bool) 1u)
#define SREGS_ESP_WAKE_DEFAULT_STATE        ((bool) 1u)
#define SREGS_DIG_OUT2_DEFAULT_STATE        ((bool) 0u)
